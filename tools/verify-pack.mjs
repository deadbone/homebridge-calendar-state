...
const packDirectory = mkdtempSync(join(tmpdir(), 'calendar-state-pack-'));
...
try {
  ...
  const requiredFiles = ['dist/index.js', 'assets/icon.png', 'config.schema.json', 'README.md', 'CHANGELOG.md', 'LICENSE'];
